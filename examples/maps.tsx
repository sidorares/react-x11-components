...
//
// Needs a real `$DISPLAY` and a network. The `fetch` in `./map-sources.ts` is
// the whole of what this package will not do for you: it is where the user agent, the
...
import { Map, openMapTilesStyle, shortbreadStyle } from '../src/maps/index.js';
import type {
  LngLat,
  MapFrameStats,
  MapHandle,
