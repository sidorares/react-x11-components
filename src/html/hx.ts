...
//
// A copy of `src/markdown/hx.ts`, deliberately: it is nine lines of types,
// and importing it would make one component depend on another, which is the
// one thing the layout rules forbid outright.
